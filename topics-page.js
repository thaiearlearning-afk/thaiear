...
(function () {
  ...
  /* The keeper itself now lives in topics.js (ThaiEarTopics.scrollKeeper) — ONE copy, shared
     with the playlist list, and extended to the "← Back to …" buttons. The reasoning above is
     kept because it is still why it exists; the mechanism and its traps are in that block. */
  if (T && T.scrollKeeper) T.scrollKeeper.install();
