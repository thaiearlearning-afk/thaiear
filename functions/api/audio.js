...
export async function onRequestGet(context) {
  ...
  const premiumList = listEnv(env.PREMIUM_PREFIXES, ['Colours_BEG', 'Time_BEG', 'Home_BEG', 'Shopping_BEG', 'Transport_BEG', 'Transport_LI1', 'Health_BEG', 'Health_LI1', 'Feelings_BEG', 'Feelings_LI1']);
