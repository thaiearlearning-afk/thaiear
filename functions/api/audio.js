...
export async function onRequestGet(context) {
  ...
  const memberList = listEnv(env.MEMBER_PREFIXES, ['Weather_BEG', 'ToneTwister_LI1', 'SocialLife_BEG', 'Plans_BEG', 'Plans_LI1', 'Clothing_BEG', 'Appearance_LI1', 'Cooking_BEG', 'Recipes_LI1']);
