...
export async function onRequestGet(context) {
  ...
  const premiumList = listEnv(env.PREMIUM_PREFIXES, ['ColoursAndDescriptions2_BEG', 'ShoppingAndMoney2_BEG', 'HomeAndDailyRoutine_BEG', 'HomeAndDailyRoutine2_BEG', 'Weather_BEG', 'Time_BEG', 'Dates_BEG', 'Family_BEG', 'Food_LI1', 'Transport_BEG', 'Transport_LI1', 'Emergency_BEG', 'Health_BEG', 'Health_LI1', 'Feelings_LI1', 'Hobbies_BEG', 'SocialLife_BEG', 'Idiom_BEG', 'Plans_LI1', 'Appearance_LI1', 'Cooking_BEG', 'Recipes_LI1', 'Workplace_LI1', 'Career_LI2', 'Study_LI1', 'System_LI2', 'FoodCulture_LI2', 'ToneTwister_LI1', 'Animals_BEG', 'Places2_BEG', 'Occupations_LI1', 'Dhamma_LI2', 'Monastic_LI2', 'Sport_LI2']);
  const memberList = listEnv(env.MEMBER_PREFIXES, ['ColoursAndDescriptions_BEG', 'ShoppingAndMoney_BEG', 'Food_BEG', 'Feelings_BEG', 'Plans_BEG', 'Clothing_BEG', 'Job_LI1', 'Schooling_LI1', 'FoodSocial_LI1', 'Places_BEG', 'Occupations_BEG', 'Buddhism_LI1', 'Sport_LI1']);
