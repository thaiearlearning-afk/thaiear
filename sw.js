/* ============================================================
   ...
   ============================================================ */
const VERSION = 'v594';   // v594: the Thai Builder's tray now reads topic.quiz.bchips when a sentence has one. quiz.js is precached and cache-first, so this bump is what delivers it; v593 is spent. ⛔ WHAT bchips IS FOR: a corpus chip whose THAI is discontinuous — ลอง...ดู "give it a try" — describes ONE construction wrapping its object, and the topic page keeps it (owner, 2026-09-21: "leave the ellipsis chips as they are in the topics themselves and author split versions only visible in the thai builder"). A single draggable TILE cannot occupy two positions, so gen_builder_chips.py publishes the Builder's own list, already ordered to spell the sentence. ⚠ TRAY AND TRAY-COUNT ONLY — every reveal surface still calls chipsOf(), because meeting ลอง...ดู as one thing is the whole reason the corpus was left alone.
