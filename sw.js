/* ============================================================
   ...
   ============================================================ */
const VERSION = 'v646';   // v646: about.html names the quizzes one sentence EARLIER. Owner, 2026-09-23: "just adds the mention of quizzes earlier" -- the "Whether you make your own Custom playlists or listen by topic" sentence becomes "Whether you listen by topics, take our quizzes, or make your own Custom playlists". A copy-only follow-up to v644, which had put the quizzes in the active-recall bullet and the implementation paragraph BELOW this line; naming them here means the page mentions them before it explains them, which is the right way round. about.html is precached and served cache-first, so a returning device needs the bump to see one changed sentence. v645 is a peer s and is spent -- it was held uncommitted on this shared tree while I was assembling this, and the blob for it was being built from HEAD through the object store when the peer committed and MOVED HEAD; the guard that re-reads HEAD caught it and this bump was re-derived rather than shipped against a HEAD that no longer existed.
