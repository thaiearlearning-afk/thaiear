  ...
  function dynStampUnitQz() {
    ...
    dynQzSigLoad().then(function (map) {
      ...
      try {
        ...
        var pver = map && map.ver;
        if (pver && pver[unit] != null) { e.ver = pver[unit]; dlFreshStamp = true; }
        setManifest(m);
      } catch (_) {}
    }).catch(function () {});
  }
