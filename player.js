...
(function () {
  ...
  function dynPrefsRepaintControls() {
    ...
    var spEl = $('dyn-sp');
    if (spEl) { var i = SP_STEPS.indexOf(dynSnapSp(dynSpeed)); spEl.value = String(i < 0 ? 0 : i); }
    var reps = $('dyn-reps');
