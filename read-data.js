...
window.ThaiEarRead = {
  ...
  "vowels": [
    ...
    { "cls": "vlong", "ch": "◌ือ",  "name": "sara uue", "alt": "◌ื◌", "sound": "uue — \"oo\" with unrounded lips",   "ex": "มือ",  "ext": "muue", "en": "hand",       "audio": "sara-uue", "ttsName": "สระอือ",  "ttsEx": "มือ" },
    ...
    { "cls": "vlong", "ch": "เ◌อ", "name": "sara uhr", "alt": "เ◌ิ◌", "note": "There is a third form. Before most final consonants the อ becomes ◌ิ (เดิน, เงิน, เกิด), but when the final is ย the อ disappears altogether and it is written เ◌ย — as in เคย khoei (ever / used to) and เลย loei. Same vowel sound in all three.",  "sound": "uhr — as in \"eugh\" (the sound of disgust)", "ex": "เธอ", "ext": "thuhr", "en": "she / you",  "audio": "sara-oe",  "ttsName": "สระเออ", "ttsEx": "เธอ" },

    { "cls": "vshort", "ch": "◌ะ",   "name": "sara a", "alt": "◌ั◌",        "sound": "a — short, as in \"apple\"",         "ex": "จะ",   "ext": "jà",   "en": "will",      "audio": "sara-a",       "ttsName": "สระอะ",   "ttsEx": "จะ" },
    ...
    { "cls": "vshort", "ch": "เ◌ะ",  "name": "sara e", "alt": "เ◌็◌",        "sound": "e — short, as in \"let\"",           "ex": "เตะ",  "ext": "dtè",  "en": "to kick",   "audio": "sara-e",       "ttsName": "สระเอะ",  "ttsEx": "เตะ" },
    { "cls": "vshort", "ch": "แ◌ะ",  "name": "sara ae", "alt": "แ◌็◌",       "sound": "ae — as in \"eh\" (indifference)",   "ex": "แกะ",  "ext": "gàe",  "en": "sheep",     "audio": "sara-ae",      "ttsName": "สระแอะ",  "ttsEx": "แกะ" },
    { "cls": "vshort", "ch": "โ◌ะ",  "name": "sara o", "alt": "◌◌", "note": "◌◌ means no vowel is written at all. When a final consonant follows, the short o is simply left out: คน khon (person), รถ rót (car), ธง thong (flag).",        "sound": "o — short, clipped \"go\"",          "ex": "โต๊ะ",  "ext": "dtó",  "en": "table",     "audio": "sara-o",       "ttsName": "สระโอะ",  "ttsEx": "โต๊ะ" },
    { "cls": "vshort", "ch": "เ◌าะ", "name": "sara aw (short)", "alt": "◌็อ◌","sound": "aw — short, as in British \"hot\"", "ex": "เกาะ", "ext": "gàw",  "en": "island",    "audio": "sara-aw-short","ttsName": "สระเอาะ", "ttsEx": "เกาะ" },
    ...
    { "cls": "vspecial", "ch": "◌ัว",  "name": "sara ua", "alt": "◌ว◌",              "sound": "ua — glides \"oo → ah\"",                  "ex": "กลัว",  "ext": "glua", "en": "afraid",   "audio": "sara-ua",         "ttsName": "สระอัว",           "ttsEx": "กลัว" },
