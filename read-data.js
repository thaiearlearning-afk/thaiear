...
window.ThaiEarRead = {
  "sections": [
    ...
    { "key": "vshort",   "kind": "vowels",  "title": "Short vowels", "short": "Short vowels",
      ...
      "blurb": "9 vowels",
      "intro": "Each long vowel has a short partner — same mouth shape, clipped off quickly, usually written by adding ะ. Two extra spelling habits to know: when a syllable has a final consonant, short a is written with อั above the consonant instead of อะ (กับ gàp — 'with'), and the little อ็ shortens เอ and แอ (เด็ก dèk — 'child'). A short vowel with no final consonant makes a syllable 'dead' — which the tone rules care about a lot." },
    { "key": "vspecial", "kind": "vowels",  "title": "Special vowels", "short": "Special vowels",
      "page": "read-vowels-special.html",
      "blurb": "8 vowels",
      "intro": "The leftovers — and some of the most common syllables in Thai. Four of them secretly contain their own ending sound: อำ ends in m, ใอ and ไอ end in y, เอา ends in w — so syllables built on them count as 'live' for the tone rules. ใอ and ไอ sound identical; only 20 words use ใอ (all others use ไอ). The three gliding vowels (เอีย, เอือ, อัว) slide from one vowel into another. ฤ is a rare consonant-vowel hybrid you'll mostly meet in ฤดู (season)." },
  ...
  "vowels": [
    { "cls": "vlong", "ch": "อา",  "name": "sara aa",  "sound": "aa — as in \"father\"",              "ex": "มา",  "ext": "maa",  "en": "to come",    "audio": "sara-aa",  "ttsName": "สระอา",  "ttsEx": "มา" },
    { "cls": "vlong", "ch": "อี",   "name": "sara ii",  "sound": "ii — as in \"see\"",                 "ex": "ดี",   "ext": "dii",  "en": "good",       "audio": "sara-ii",  "ttsName": "สระอี",   "ttsEx": "ดี" },
    { "cls": "vlong", "ch": "อือ",  "name": "sara uue", "alt": "อื◌", "sound": "uue — \"oo\" with unrounded lips",   "ex": "มือ",  "ext": "muue", "en": "hand",       "audio": "sara-uue", "ttsName": "สระอือ",  "ttsEx": "มือ" },
    { "cls": "vlong", "ch": "อู",   "name": "sara uu",  "sound": "uu — as in \"moon\"",                "ex": "งู",   "ext": "nguu", "en": "snake",      "audio": "sara-uu",  "ttsName": "สระอู",   "ttsEx": "งู" },
    { "cls": "vlong", "ch": "เอ",  "name": "sara ee",  "sound": "ee — as in \"pay\" (no y-glide)",    "ex": "เพลง",  "ext": "phleeng", "en": "song",    "audio": "sara-ee",  "ttsName": "สระเอ",  "ttsEx": "เพลง" },
    { "cls": "vlong", "ch": "แอ",  "name": "sara aae", "sound": "aae — as in \"fair\"",              "ex": "แม่",  "ext": "mâae", "en": "mother",     "audio": "sara-aae", "ttsName": "สระแอ",  "ttsEx": "แม่" },
    { "cls": "vlong", "ch": "โอ",  "name": "sara oo",  "sound": "oo — as in \"go\" (no w-glide)",     "ex": "โต",  "ext": "dtoo", "en": "big",        "audio": "sara-oo",  "ttsName": "สระโอ",  "ttsEx": "โต" },
    { "cls": "vlong", "ch": "ออ",  "name": "sara aw",  "sound": "aw — as in \"saw\"",                 "ex": "ขอ",  "ext": "khǎw", "en": "to ask for", "audio": "sara-aw",  "ttsName": "สระออ",  "ttsEx": "ขอ" },
    { "cls": "vlong", "ch": "เออ", "name": "sara uhr", "alt": "เอิ◌ / เอย",  "sound": "uhr — as in \"eugh\" (the sound of disgust)", "ex": "เธอ", "ext": "thuhr", "en": "she / you",  "audio": "sara-oe",  "ttsName": "สระเออ", "ttsEx": "เธอ" },

    { "cls": "vshort", "ch": "อะ",   "name": "sara a", "alt": "อั◌",        "sound": "a — short, as in \"apple\"",         "ex": "จะ",   "ext": "jà",   "en": "will",      "audio": "sara-a",       "ttsName": "สระอะ",   "ttsEx": "จะ" },
    { "cls": "vshort", "ch": "อิ",    "name": "sara i",        "sound": "i — short, as in \"bit\"",           "ex": "กิน",  "ext": "gin",  "en": "to eat",    "audio": "sara-i",       "ttsName": "สระอิ",    "ttsEx": "กิน" },
    { "cls": "vshort", "ch": "อึ",    "name": "sara ue",       "sound": "ue — short unrounded \"oo\"",        "ex": "ถึง",   "ext": "thǔeng","en": "to reach", "audio": "sara-ue",      "ttsName": "สระอึ",    "ttsEx": "ถึง" },
    ...
    { "cls": "vspecial", "ch": "อำ",  "name": "sara am",              "sound": "am — as in \"scramble\" (ends in m → live)", "ex": "ทำ",   "ext": "tham", "en": "to do",    "audio": "sara-am",         "ttsName": "สระอำ",           "ttsEx": "ทำ" },
    { "cls": "vspecial", "ch": "ใอ",  "name": "sara ai (mái múan)",   "sound": "ai — as in \"eye\" (only 20 words use it)","ex": "ใจ",   "ext": "jai",  "en": "heart",    "audio": "sara-ai-maimuan", "ttsName": "สระใอ ไม้ม้วน",     "ttsEx": "ใจ" },
    { "cls": "vspecial", "ch": "ไอ",  "name": "sara ai (mái má-laai)","sound": "ai — as in \"eye\" (the usual spelling)",  "ex": "ไป",   "ext": "bpai", "en": "to go",    "audio": "sara-ai-maimalaai","ttsName": "สระไอ ไม้มะลาย",  "ttsEx": "ไป" },
    { "cls": "vspecial", "ch": "เอา", "name": "sara ao",              "sound": "ao — as in \"cow\" (ends in w → live)",    "ex": "เอา",  "ext": "ao",   "en": "to take",  "audio": "sara-ao",         "ttsName": "สระเอา",          "ttsEx": "เอา" },
    { "cls": "vspecial", "ch": "อัว",  "name": "sara ua", "alt": "อว◌",              "sound": "ua — glides \"oo → ah\"",                  "ex": "กลัว",  "ext": "glua", "en": "afraid",   "audio": "sara-ua",         "ttsName": "สระอัว",           "ttsEx": "กลัว" },
    { "cls": "vspecial", "ch": "เอีย", "name": "sara ia",              "sound": "ia — glides \"ee → ah\"",                  "ex": "เรียน", "ext": "rian", "en": "to study", "audio": "sara-ia",         "ttsName": "สระเอีย",          "ttsEx": "เรียน" },
    { "cls": "vspecial", "ch": "เอือ", "name": "sara uea",             "sound": "uea — glides \"uue → ah\"",                "ex": "เรือ",  "ext": "ruea", "en": "boat",     "audio": "sara-uea",        "ttsName": "สระเอือ",          "ttsEx": "เรือ" },
  ...
  "toneMarks": [
    { "mark": "อ่", "name": "mái èek",        "t": "" },
    { "mark": "อ้", "name": "mái thoo",       "t": "" },
    { "mark": "อ๊", "name": "mái dtrii",      "t": "mid-class words only" },
    { "mark": "อ๋", "name": "mái jàt-dtà-waa","t": "mid-class words only" }
  ],

  "toneRules": {
    "columns": ["No mark — live", "No mark — dead, short", "No mark — dead, long", "+ อ่", "+ อ้", "+ อ๊", "+ อ๋"],
    "rows": [
      { "cls": "Mid class", "cells": [
