...
(function () {
  ...
  const topics = [
    ...
    { id: 11, part: 1, name: "Shopping & money: Prices & paying", levels: ['beg'], sentences: 22, page: "topic-11a.html", audio: "ShoppingAndMoney_BEG",
    ...
    { id: 4, part: 1, name: "Colours & descriptions: Colours", levels: ['beg'], sentences: 21, page: "topic-04a.html", audio: "ColoursAndDescriptions_BEG", access: "premium",
      keywords: ['colour','color','red','blue','green','สี','describe','description','adjective','big','small','แดง'] },
    { id: 4, part: 2, name: "Colours & descriptions: Everyday qualities", levels: ['beg'], sentences: 22, page: "topic-04b.html", audio: "ColoursAndDescriptions2_BEG", access: "premium",
    ...
    { id: 41, part: 1, name: "Places around town: Finding places & hours", levels: ['beg'], sentences: 28, page: "topic-41a.html", audio: "Places_BEG", access: "premium",
    ...
    { id: 19, part: 1, name: "Cooking & recipes: Techniques & kit", levels: ['beg'], sentences: 34, page: "topic-19a.html", audio: "Cooking_BEG", access: "premium",
    ...
    { id: 12, part: 1, name: "Getting around & transport: Modes & tickets", levels: ['beg'], sentences: 27, page: "topic-12a.html", audio: "Transport_BEG", access: "premium",
    ...
    { id: 42, part: 1, name: "Occupations: Everyday jobs", levels: ['beg','li1'], sentences: 30, page: "topic-42a.html", audio: "Occupations_BEG",
      keywords: ['job','occupation','อาชีพ','work','งาน','teacher','ครู','doctor','หมอ','farmer','ชาวนา','profession','police','nurse','engineer'] },
    { id: 13, part: 1, name: "Body & health: Symptoms & feeling ill", levels: ['beg','li1'], sentences: 30, page: "topic-13b.html", audio: "Health_BEG", access: "premium",
    ...
    { id: 41, part: 2, name: "Places around town: Shops & errands", levels: ['beg','li1'], sentences: 29, page: "topic-41b.html", audio: "Places2_BEG", access: "premium",
    ...
    { id: 36, part: 1, name: "Romance & dating: Crushes & flirting", levels: ['beg','li1'], sentences: 29, page: "topic-36b.html", audio: "Romance2_LI1", access: "premium",
    ...
    { id: 18, part: 1, name: "Clothing & appearance: Everyday clothes & sizes", levels: ['beg','li1'], sentences: 26, page: "topic-18a.html", audio: "Clothing_BEG", access: "premium",
    ...
    { id: 49, part: 1, name: "Compliments & opinions: Praise & warmth", levels: ['beg','li1'], sentences: 33, page: "topic-49a.html", audio: "Compliments_LI1", access: "premium",
      keywords: ['compliment','ชม','praise','nice','good','เก่ง','well done','flatter','admire','kind words','ชมเชย'] },
    { id: 11, part: 2, name: "Shopping & money: Choosing & quality", levels: ['beg','li1'], sentences: 30, page: "topic-11b.html", audio: "ShoppingAndMoney2_BEG", access: "premium",
      keywords: ['shopping','money','เงิน','bargain','ต่อรอง','discount','ลด','change','ทอน','market','ตลาด','receipt','pay','จ่าย','cash'] },
    { id: 19, part: 2, name: "Cooking & recipes: Ingredients & seasoning", levels: ['beg','li1'], sentences: 28, page: "topic-19b.html", audio: "Recipes_LI1", access: "premium",
      keywords: ['recipe','สูตร','cooking','ingredient','ส่วนผสม','step','measure','instructions','dish','เมนู','prepare','mix','season'] },
    { id: 37, part: 2, name: "Emergencies: Accidents & first aid", levels: ['beg','li1'], sentences: 19, page: "topic-37b.html", audio: "Emergency2_BEG", access: "premium",
      keywords: ['help','emergency','ช่วย','ฉุกเฉิน','police','ตำรวจ','ambulance','accident','อุบัติเหตุ','fire','ไฟไหม้','danger','hospital','lost','urgent','สายด่วน'] },
    { id: 10, part: 1, name: "Home & daily routine: Routine & rooms", levels: ['beg','li1'], sentences: 32, page: "topic-10a.html", audio: "HomeAndDailyRoutine_BEG", access: "premium",
    ...
    { id: 13, part: 2, name: "Body & health: Body parts", levels: ['beg','li1'], sentences: 26, page: "topic-13a.html", audio: "BodyHealth_BEG", access: "premium",
      keywords: ['body','ร่างกาย','body parts','head','หัว','eye','ตา','ear','หู','hand','มือ','leg','ขา','anatomy','knee','เข่า'] },
    { id: 17, part: 1, name: "Plans & future: Arranging & changing plans", levels: ['beg','li1'], sentences: 28, page: "topic-17a.html", audio: "Plans_BEG", access: "premium",
      keywords: ['plan','แผน','future','อนาคต','will','จะ','intend','tomorrow','schedule','appointment','นัด','arrange','soon'] },
    { id: 42, part: 2, name: "Occupations: Professions & careers", levels: ['beg','li1'], sentences: 32, page: "topic-42b.html", audio: "Occupations_LI1", access: "premium",
      keywords: ['job','occupation','อาชีพ','work','career','งาน','skill','profession','employ','duties','role','workplace'] },
    { id: 18, part: 2, name: "Clothing & appearance: Accessories & looks", levels: ['beg','li1'], sentences: 23, page: "topic-18c.html", audio: "Clothing2_BEG", access: "premium",
      keywords: ['clothes','clothing','เสื้อผ้า','shirt','เสื้อ','trousers','กางเกง','shoes','รองเท้า','wear','ใส่','dress','size','fashion'] },
    { id: 49, part: 2, name: "Compliments & opinions: Criticism & disagreement", levels: ['beg','li1'], sentences: 34, page: "topic-49b.html", audio: "Opinions_LI1", access: "premium",
      keywords: ['opinion','ความเห็น','think','คิด','agree','เห็นด้วย','disagree','argue','view','believe','เชื่อ','discuss','debate'] },
    { id: 20, part: 1, name: "Working life: On the job", levels: ['beg','li1'], sentences: 24, page: "topic-20a.html", audio: "Job_LI1", access: "premium",
    ...
    { id: 22, part: 1, name: "Food culture: Eating together", levels: ['li1','int'], sentences: 29, page: "topic-22a.html", audio: "FoodSocial_LI1",
      keywords: ['restaurant','ร้านอาหาร','eating out','order','สั่ง','menu','เมนู','waiter','bill','เช็คบิล','table','จอง','food culture','dining'] },
    { id: 21, part: 1, name: "Education system: Schools & stages", levels: ['li1','int'], sentences: 28, page: "topic-21a.html", audio: "Schooling_LI1", access: "premium",
      keywords: ['education','การศึกษา','school','โรงเรียน','study','เรียน','teacher','ครู','student','นักเรียน','class','subject','วิชา','schooling'] },
    { id: 16, part: 1, name: "Social life & events: Festivals & celebrations", levels: ['li1','int'], sentences: 21, page: "topic-16.html", audio: "SocialLife_BEG", access: "premium",
      keywords: ['social','party','ปาร์ตี้','event','งาน','invite','ชวน','friends','เพื่อน','meet','นัด','celebrate','ฉลอง','birthday','wedding','งานแต่ง'] },
    { id: 10, part: 2, name: "Home & daily routine: Appliances & housework", levels: ['li1','int'], sentences: 32, page: "topic-10b.html", audio: "HomeAndDailyRoutine2_BEG", access: "premium",
      keywords: ['home','house','บ้าน','housework','chores','งานบ้าน','clean','ทำความสะอาด','laundry','ซักผ้า','wash','routine','tidy','evening'] },
    { id: 36, part: 2, name: "Romance & dating: Apps & first dates", levels: ['li1','int'], sentences: 24, page: "topic-36a.html", audio: "Romance_LI1", access: "premium",
    ...
    { id: 36, part: 3, name: "Romance & dating: Conflict & breakups", levels: ['li1','int'], sentences: 29, page: "topic-36d.html", audio: "Romance4_LI1", access: "premium",
      keywords: ['jealousy','หึง','trust','ไว้ใจ','argue','ทะเลาะ','fight','เถียง','breakup','เลิก','unfaithful','นอกใจ','conflict','sulk','งอน','romance'] },
    { id: 13, part: 3, name: "Body & health: Inside the body", levels: ['li1','int'], sentences: 15, page: "topic-13d.html", audio: "BodyHealth2_BEG", access: "premium",
      keywords: ['body','ร่างกาย','body parts','head','หัว','eye','ตา','ear','หู','hand','มือ','leg','ขา','anatomy','knee','เข่า'] },
    { id: 18, part: 3, name: "Clothing & appearance: Style & grooming", levels: ['li1','int'], sentences: 21, page: "topic-18b.html", audio: "Appearance_LI1", access: "premium",
      keywords: ['appearance','หน้าตา','look','describe','handsome','หล่อ','beautiful','สวย','hair','ผม','tall','สูง','style','face'] },
    { id: 23, part: 1, name: "Nature & environment: Landscapes & wildlife", levels: ['li1','int'], sentences: 25, page: "topic-23a.html", audio: "Nature_LI1", access: "premium",
      keywords: ['nature','ธรรมชาติ','environment','สิ่งแวดล้อม','tree','ต้นไม้','forest','ป่า','river','แม่น้ำ','mountain','ภูเขา','sea','ทะเล','outdoors'] },
    { id: 24, part: 1, name: "Technology: Calls & messaging", levels: ['li1','int'], sentences: 24, page: "topic-24a.html", audio: "Tech_LI1", access: "premium",
    ...
    { id: 45, part: 1, name: "School & university: School years", levels: ['li1','int'], sentences: 28, page: "topic-45a.html", audio: "School_LI1", access: "premium",
      keywords: ['school','โรงเรียน','university','มหาวิทยาลัย','study','เรียน','exam','สอบ','homework','การบ้าน','student','นักศึกษา','class','lecture'] },
    { id: 45, part: 2, name: "School & university: Student life", levels: ['li1','int'], sentences: 30, page: "topic-45b.html", audio: "Campus_LI1", access: "premium",
      keywords: ['university','มหาวิทยาลัย','campus','แคมปัส','student life','faculty','คณะ','degree','ปริญญา','dorm','graduate','จบ','lecture'] },
    { id: 13, part: 4, name: "Body & health: Doctors & mental health", levels: ['li1','int'], sentences: 27, page: "topic-13c.html", audio: "Health_LI1", access: "premium",
    ...
    { id: 48, part: 1, name: "Household supplies: Toiletries & stationery", levels: ['li1','int'], sentences: 18, page: "topic-48.html", audio: "HouseholdSupplies_BEG", access: "premium",
      keywords: ['household','supplies','ของใช้','soap','สบู่','detergent','ผงซักฟอก','tissue','cleaning','shop','ร้าน','home goods','toiletries','แชมพู'] },
    { id: 27, part: 1, name: "Travel & tourism: Planning a trip", levels: ['li1','int'], sentences: 27, page: "topic-27a.html", audio: "Travel_LI1", access: "premium",
      keywords: ['travel','เที่ยว','tourism','ท่องเที่ยว','trip','ทริป','holiday','วันหยุด','hotel','โรงแรม','book','จอง','flight','เครื่องบิน','sightseeing'] },
    { id: 27, part: 2, name: "Travel & tourism: Booking & getting there", levels: ['li1','int'], sentences: 27, page: "topic-27b.html", audio: "Travel2_LI1", access: "premium",
      keywords: ['travel','เที่ยว','tourism','sightseeing','attraction','สถานที่','beach','ทะเล','island','เกาะ','tour','ทัวร์','guide','itinerary','holiday'] },
    { id: 36, part: 4, name: "Romance & dating: Commitment & marriage", levels: ['li1','int'], sentences: 27, page: "topic-36c.html", audio: "Romance3_LI1", access: "premium",
      keywords: ['love','รัก','commitment','soulmate','เนื้อคู่','in laws','marriage','แต่งงาน','devotion','milestone','partner','romance'] },
    // ── INTERMEDIATE → UPPER INTERMEDIATE ─────────────────
    { id: 34, part: 1, name: "Thai culture & customs: Respect & etiquette", levels: ['int','li2'], sentences: 22, page: "topic-34a.html", audio: "ThaiCulture_LI1",
      keywords: ['thai culture','วัฒนธรรม','custom','ประเพณี','tradition','wai','ไหว้','respect','เคารพ','etiquette','มารยาท','manners','face','เกรงใจ'] },
    { id: 20, part: 2, name: "Working life: Colleagues & workplace", levels: ['int','li2'], sentences: 24, page: "topic-20b.html", audio: "Workplace_LI1", access: "premium",
      keywords: ['workplace','ที่ทำงาน','office','ออฟฟิศ','colleague','เพื่อนร่วมงาน','meeting','ประชุม','boss','เจ้านาย','deadline','email','work'] },
    { id: 12, part: 2, name: "Getting around & transport: Directions & journeys", levels: ['int','li2'], sentences: 26, page: "topic-12b.html", audio: "Transport_LI1", access: "premium",
    ...
    { id: 16, part: 2, name: "Social life & events: Invitations & get-togethers", levels: ['int','li2'], sentences: 19, page: "topic-16b.html", audio: "SocialLife2_BEG", access: "premium",
      keywords: ['social','party','ปาร์ตี้','event','งาน','invite','ชวน','friends','เพื่อน','meet','นัด','celebrate','ฉลอง','birthday','wedding','งานแต่ง'] },
    { id: 17, part: 2, name: "Plans & future: Hopes & uncertainty", levels: ['int','li2'], sentences: 17, page: "topic-17b.html", audio: "Plans_LI1", access: "premium",
    ...
    { id: 21, part: 2, name: "Education system: Issues & reform", levels: ['int','li2'], sentences: 24, page: "topic-21b.html", audio: "System_LI2", access: "premium",
      keywords: ['education','การศึกษา','system','ระบบ','curriculum','หลักสูตร','exam','สอบ','policy','university','degree','ปริญญา','schooling','reform'] },
    { id: 26, part: 1, name: "Sport & exercise: Playing & keeping fit", levels: ['int','li2'], sentences: 26, page: "topic-26a.html", audio: "Sport_LI1", access: "premium",
      keywords: ['sport','กีฬา','exercise','ออกกำลังกาย','football','ฟุตบอล','run','วิ่ง','gym','ยิม','play','เล่น','fitness','swim','ว่ายน้ำ'] },
    { id: 47, part: 1, name: "Homes & housing: Types of home", levels: ['int','li2'], sentences: 16, page: "topic-47.html", audio: "HomesAndHousing_LI1", access: "premium",
    ...
    { id: 24, part: 2, name: "Technology: Devices & fixes", levels: ['int','li2'], sentences: 25, page: "topic-24b.html", audio: "Tech2_LI1", access: "premium",
      keywords: ['technology','เทคโนโลยี','social media','โซเชียล','post','โพสต์','account','บัญชี','password','รหัสผ่าน','wifi','ไวไฟ','device','digital'] },
    { id: 24, part: 3, name: "Technology: Life online & scams", levels: ['int','li2'], sentences: 24, page: "topic-24c.html", audio: "Tech3_LI1", access: "premium",
    ...
    { id: 29, part: 1, name: "Community & society: Neighbours & village life", levels: ['int','li2'], sentences: 21, page: "topic-29a.html", audio: "Community_LI1", access: "premium",
      keywords: ['community','ชุมชน','society','สังคม','neighbour','เพื่อนบ้าน','village','หมู่บ้าน','local','volunteer','อาสา','help','public'] },
    { id: 26, part: 2, name: "Sport & exercise: Watching & Thai sport", levels: ['int','li2'], sentences: 26, page: "topic-26b.html", audio: "Sport_LI2", access: "premium",
    ...
    { id: 23, part: 2, name: "Nature & environment: Pollution & habitat loss", levels: ['int','li2'], sentences: 18, page: "topic-23c.html", audio: "Nature2_LI1", access: "premium",
      keywords: ['nature','ธรรมชาติ','environment','สิ่งแวดล้อม','tree','ต้นไม้','forest','ป่า','river','แม่น้ำ','mountain','ภูเขา','sea','ทะเล','outdoors'] },
    { id: 20, part: 3, name: "Working life: Careers & job-hunting", levels: ['int','li2'], sentences: 24, page: "topic-20c.html", audio: "Career_LI2", access: "premium",
      keywords: ['career','อาชีพ','promotion','เลื่อนตำแหน่ง','ambition','resign','ลาออก','experience','ประสบการณ์','professional','work','development'] },
    { id: 27, part: 3, name: "Travel & tourism: Mishaps & etiquette", levels: ['int','li2'], sentences: 25, page: "topic-27c.html", audio: "Travel_LI2", access: "premium",
    ...
    { id: 35, part: 1, name: "Buddhism: At the temple", levels: ['int','li2'], sentences: 21, page: "topic-35a.html", audio: "Temple_LI1", access: "premium",
      keywords: ['buddhism','พุทธ','temple','วัด','monk','พระ','merit','ทำบุญ','offering','ใส่บาตร','pray','religion','ศาสนา','shrine'] },
    { id: 48, part: 2, name: "Household supplies: Post & personal care", levels: ['int','li2'], sentences: 19, page: "topic-48b.html", audio: "HouseholdSupplies2_BEG", access: "premium",
      keywords: ['household','supplies','ของใช้','soap','สบู่','detergent','ผงซักฟอก','tissue','cleaning','shop','ร้าน','home goods','toiletries','แชมพู'] },
    { id: 34, part: 2, name: "Thai culture & customs: Face & values", levels: ['int','li2'], sentences: 23, page: "topic-34b.html", audio: "ThaiCulture_LI2", access: "premium",
    ...
    { id: 32, part: 1, name: "Thai geography: Regions & provinces", levels: ['li2','adv'], sentences: 21, page: "topic-32a.html", audio: "GeoRegions_LI1",
      keywords: ['geography','ภูมิศาสตร์','region','ภาค','province','จังหวัด','thailand','ประเทศไทย','north','เหนือ','south','ใต้','map','area','isaan','อีสาน'] },
    { id: 23, part: 3, name: "Nature & environment: Climate & conservation", levels: ['li2','adv'], sentences: 21, page: "topic-23b.html", audio: "Nature_LI2", access: "premium",
    ...
    { id: 35, part: 2, name: "Buddhism: Holy days & precepts", levels: ['li2','adv'], sentences: 18, page: "topic-35b.html", audio: "HolyDays_LI1", access: "premium",
    ...
    { id: 29, part: 2, name: "Community & society: Hardship & inequality", levels: ['li2','adv'], sentences: 20, page: "topic-29c.html", audio: "Community2_LI1", access: "premium",
      keywords: ['community','ชุมชน','society','สังคม','neighbour','เพื่อนบ้าน','village','หมู่บ้าน','local','volunteer','อาสา','help','public'] },
    { id: 22, part: 2, name: "Food culture: Regional food & etiquette", levels: ['li2','adv'], sentences: 23, page: "topic-22b.html", audio: "FoodCulture_LI2", access: "premium",
    ...
    { id: 25, part: 1, name: "Media & entertainment: TV, film & streaming", levels: ['li2','adv'], sentences: 17, page: "topic-25a.html", audio: "Media_LI1", access: "premium",
      keywords: ['media','สื่อ','entertainment','บันเทิง','tv','ทีวี','film','หนัง','movie','music','เพลง','series','ละคร','watch','ดู','show'] },
    { id: 25, part: 2, name: "Media & entertainment: Music, genres & books", levels: ['li2','adv'], sentences: 20, page: "topic-25c.html", audio: "Media3_LI1", access: "premium",
      keywords: ['media','สื่อ','entertainment','บันเทิง','tv','ทีวี','film','หนัง','movie','music','เพลง','series','ละคร','watch','ดู','show'] },
    { id: 47, part: 2, name: "Homes & housing: Features & fittings", levels: ['li2','adv'], sentences: 13, page: "topic-47b.html", audio: "HomesAndHousing2_LI1", access: "premium",
      keywords: ['house','บ้าน','housing','rent','เช่า','condo','คอนโด','apartment','อพาร์ตเมนต์','landlord','เจ้าของบ้าน','move','ย้าย','property','lease','deposit'] },
    { id: 35, part: 3, name: "Buddhism: Merit & the unseen", levels: ['li2','adv'], sentences: 13, page: "topic-35f.html", audio: "Meditation2_LI2", access: "premium",
      keywords: ['meditation','สมาธิ','buddhism','พุทธ','mindfulness','สติ','vipassana','วิปัสสนา','retreat','breathe','calm','สงบ','practice','religion'] },
    { id: 35, part: 4, name: "Buddhism: Monastic daily life", levels: ['li2','adv'], sentences: 15, page: "topic-35g.html", audio: "Monastic2_LI2", access: "premium",
      keywords: ['monastic','สงฆ์','monk','พระ','ordination','บวช','temple','วัด','monastery','robe','จีวร','buddhism','พุทธ','religion','novice','เณร'] },
    { id: 29, part: 3, name: "Community & society: A changing society", levels: ['li2','adv'], sentences: 19, page: "topic-29b.html", audio: "Community_LI2", access: "premium",
    ...
    { id: 32, part: 2, name: "Thai geography: Dialects & climate", levels: ['li2','adv'], sentences: 16, page: "topic-32c.html", audio: "GeoRegions2_LI1", access: "premium",
      keywords: ['geography','ภูมิศาสตร์','region','ภาค','province','จังหวัด','thailand','ประเทศไทย','north','เหนือ','south','ใต้','map','area','isaan','อีสาน'] },
    { id: 35, part: 5, name: "Buddhism: Forest monks & the Vinaya", levels: ['li2','adv'], sentences: 15, page: "topic-35e.html", audio: "Monastic_LI2", access: "premium",
      keywords: ['monastic','สงฆ์','monk','พระ','ordination','บวช','temple','วัด','monastery','robe','จีวร','buddhism','พุทธ','religion','novice','เณร'] },
    { id: 25, part: 3, name: "Media & entertainment: Actors & the industry", levels: ['li2','adv'], sentences: 15, page: "topic-25b.html", audio: "Media2_LI1", access: "premium",
    ...
    { id: 35, part: 6, name: "Buddhism: The Dhamma", levels: ['li2','adv'], sentences: 19, page: "topic-35c.html", audio: "Dhamma_LI2", access: "premium",
      keywords: ['buddhism','พุทธ','dhamma','ธรรมะ','teaching','คำสอน','karma','กรรม','precept','ศีล','philosophy','ปรัชญา','religion','doctrine'] },
    { id: 32, part: 3, name: "Thai geography: Local character & change", levels: ['li2','adv'], sentences: 16, page: "topic-32b.html", audio: "GeoRegions_LI2", access: "premium",
    ...
    { id: 35, part: 7, name: "Buddhism: Meditation practice", levels: ['li2','adv'], sentences: 9, page: "topic-35d.html", audio: "Meditation_LI2", access: "premium",
      keywords: ['meditation','สมาธิ','buddhism','พุทธ','mindfulness','สติ','vipassana','วิปัสสนา','retreat','breathe','calm','สงบ','practice','religion'] },
    { id: 25, part: 4, name: "Media & entertainment: Fame & influence", levels: ['li2','adv'], sentences: 14, page: "topic-25d.html", audio: "Media4_LI1", access: "premium",
