...
(function () {
  ...
  const topics = [
    ...
    { id: 12, part: 1, name: "Getting around: Modes & tickets", levels: ['beg'], sentences: 27, page: "topic-12a.html", audio: "Transport_BEG", access: "premium",
    ...
    { id: 16, part: 1, name: "Social life: Festivals & celebrations", levels: ['li1','int'], sentences: 21, page: "topic-16.html", audio: "SocialLife_BEG", access: "premium",
    ...
    { id: 12, part: 2, name: "Getting around: Directions & journeys", levels: ['int','li2'], sentences: 26, page: "topic-12b.html", audio: "Transport_LI1", access: "premium",
    ...
    { id: 16, part: 2, name: "Social life: Invitations & get-togethers", levels: ['int','li2'], sentences: 19, page: "topic-16b.html", audio: "SocialLife2_BEG", access: "premium",
      keywords: ['social','party','ปาร์ตี้','event','งาน','invite','ชวน','friends','เพื่อน','meet','นัด','celebrate','ฉลอง','birthday','wedding','งานแต่ง'] },
    ...
    { id: 35, part: 7, name: "Buddhism: Meditation practice", levels: ['li2','adv'], sentences: 10, page: "topic-35d.html", audio: "Meditation_LI2", access: "premium",
      keywords: ['meditation','สมาธิ','buddhism','พุทธ','mindfulness','สติ','vipassana','วิปัสสนา','retreat','breathe','calm','สงบ','practice','religion'] },
