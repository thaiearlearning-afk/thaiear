...
(function () {
  ...
  const topics = [
    ...
    { id: 6,  name: "Time & numbers", levels: ["beg"], sentences: 26 },
    ...
    { id: 10, name: "Home & daily routine", levels: ["beg","li1"], sentences: 38 },
    { id: 11, name: "Shopping & money (everyday)", levels: ["beg","li1"], sentences: 30 },
    { id: 12, name: "Getting around & transport", levels: ["beg","li1"], sentences: 30 },
    { id: 37, name: "Asking for help & emergencies", levels: ["beg","li1"], sentences: 20 },
    { id: 13, name: "Body & health", levels: ["beg","li1"], parts: [20, 20] },
    { id: 14, name: "Feelings & emotions", levels: ["beg","li1"], sentences: 30 },
    { id: 15, name: "Hobbies & free time", levels: ["beg","li1"], sentences: 30 },
    { id: 16, name: "Social life & events", levels: ["beg","li1"], sentences: 25 },
    { id: 17, name: "Plans & future", levels: ["beg","li1"], sentences: 20 },
    { id: 18, name: "Clothing & appearance", levels: ["beg","li1"], sentences: 30 },
    { id: 19, name: "Cooking & recipes", levels: ["beg","li1"], sentences: 30 },
    { id: 20, name: "Work & study", levels: ["li1","li2"], parts: [20, 20] },
    { id: 21, name: "Education system", levels: ["li1","li2"], sentences: 25 },
    { id: 22, name: "Food culture & eating out", levels: ["li1","li2"], sentences: 30 },
    { id: 23, name: "Nature & animals", levels: ["li1","li2"], sentences: 30 },
    { id: 24, name: "Technology & communication", levels: ["li1","li2"], sentences: 25 },
    { id: 25, name: "Media & entertainment", levels: ["li1","li2"], sentences: 25 },
    { id: 26, name: "Sport & exercise", levels: ["li1","li2"], sentences: 25 },
    { id: 27, name: "Travel & tourism", levels: ["li1","li2"], sentences: 30 },
    { id: 28, name: "Banking & finance", levels: ["li1","li2"], sentences: 25 },
    { id: 29, name: "Community & society", levels: ["li1","li2"], sentences: 25 },
    { id: 30, name: "Agriculture & rural life", levels: ["li1","li2"], sentences: 25 },
    { id: 31, name: "Crime, law & justice", levels: ["li1","li2"], sentences: 25 },
    { id: 32, name: "Thai geography & regions", levels: ["li1","li2"], sentences: 25 },
    { id: 33, name: "Ceremonies & rites of passage", levels: ["li1","li2"], sentences: 25 },
    { id: 34, name: "Thai culture & customs", levels: ["li1","li2"], parts: [22, 28] },
    { id: 35, name: "Buddhism", levels: ["li1","li2"], parts: [22, 28] },
    { id: 36, name: "Romantic relationships & dating", levels: ["li1","li2"], sentences: 25 },
  ];
