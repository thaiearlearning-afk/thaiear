...
(function () {
  ...
  const topics = [
    ...
    { id: 37, part: 2, name: "Asking for help & emergencies 2", levels: ['beg','li1'], sentences: 19, page: "topic-37b.html", audio: "Emergency2_BEG", access: "premium",
      keywords: ['help','emergency','ช่วย','ฉุกเฉิน','police','ตำรวจ','ambulance','accident','อุบัติเหตุ','fire','ไฟไหม้','danger','hospital','lost','urgent','สายด่วน'] },
    { id: 14, part: 1, name: "Feelings & emotions 1", levels: ['beg','li1'], sentences: 35, page: "topic-14a.html", audio: "Feelings_BEG", access: "member",
    ...
    { id: 13, part: 2, name: "Body & health 2", levels: ['li1','li2'], sentences: 15, page: "topic-13d.html", audio: "BodyHealth2_BEG", access: "premium",
      keywords: ['body','ร่างกาย','body parts','head','หัว','eye','ตา','ear','หู','hand','มือ','leg','ขา','anatomy','knee','เข่า'] },
    { id: 13, part: 3, name: "Body & health 3", levels: ['li1','li2'], sentences: 30, page: "topic-13b.html", audio: "Health_BEG", access: "premium",
    ...
    { id: 36, part: 1, name: "Romantic relationships & dating 1", levels: ['li1','li2'], sentences: 24, page: "topic-36a.html", audio: "Romance_LI1", access: "member",
    ...
    { id: 24, part: 1, name: "Technology & communication 1", levels: ['li1','li2'], sentences: 24, page: "topic-24a.html", audio: "Tech_LI1", access: "member",
    ...
    { id: 35, part: 4, name: "Buddhism 4", levels: ['li2','adv'], sentences: 10, page: "topic-35d.html", audio: "Meditation_LI2", access: "premium",
      keywords: ['meditation','สมาธิ','buddhism','พุทธ','mindfulness','สติ','vipassana','วิปัสสนา','retreat','breathe','calm','สงบ','practice','religion'] },
    { id: 35, part: 5, name: "Buddhism 5", levels: ['li2','adv'], sentences: 13, page: "topic-35f.html", audio: "Meditation2_LI2", access: "premium",
      keywords: ['meditation','สมาธิ','buddhism','พุทธ','mindfulness','สติ','vipassana','วิปัสสนา','retreat','breathe','calm','สงบ','practice','religion'] },
    { id: 35, part: 6, name: "Buddhism 6", levels: ['li2','adv'], sentences: 15, page: "topic-35e.html", audio: "Monastic_LI2", access: "premium",
      keywords: ['monastic','สงฆ์','monk','พระ','ordination','บวช','temple','วัด','monastery','robe','จีวร','buddhism','พุทธ','religion','novice','เณร'] },
    { id: 35, part: 7, name: "Buddhism 7", levels: ['li2','adv'], sentences: 15, page: "topic-35g.html", audio: "Monastic2_LI2", access: "premium",
      keywords: ['monastic','สงฆ์','monk','พระ','ordination','บวช','temple','วัด','monastery','robe','จีวร','buddhism','พุทธ','religion','novice','เณร'] },
